...
def main():
    print('Python version:', sys.version, sys.stderr)
    print('PyTorch version:', torch.__version__, sys.stderr)
    print('CUDA version', torch.version.cuda, sys.stderr)
    print('Conda env:', os.environ.get("CONDA_DEFAULT_ENV", ""), sys.stderr)
